...
let person3 = new person("Ramgopal", "Bagh");
let person2 = new person("Sonu", "Bagh");
...
let person5 = new Person("Ramgopal", 24);
...
let person6 = new Person("Ramgopal", "Sonu");
...
let person1 = new Person("Ramgopal", "Sonu");

console.log(perosn1.firstName);
console.log(person1.getDetails_NoAccess());

let studemt1 = new Student("Sonu", "Bagh", 20);
